...
> Rust-базу (safety, ownership, Result/Option, crates, **size limits**, workflow) — в `engineer-rust`. Общие правила (комментарии) — в `rules-clean-code`. Здесь только Leptos-специфика.
