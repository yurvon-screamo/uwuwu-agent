...
const embeddedMetadata = {
  ...
  "invocation": {
    ...
    "minify": false,
    "runtime": "bun",
    "serverRef": "{\"command\":{\"headers\":{\"accept\":\"application/json, text/event-stream\"},\"kind\":\"http\",\"url\":\"https://mcp.grep.app/\"},\"description\":\"mcp-typescript server on vercel\",\"name\":\"research_grep\"}",
    "timeoutMs": 30000
  },
  "schemaVersion": 1,
  "server": {
...
program
	...
	.option("--query <query>", "The literal code pattern to search for (e.g., 'useState(', 'export function'). Use actual code that would appear in files, not keywords or questions.")
	...
	.option("--language <language:value1,value2>", "Filter by programming language.\n            Examples: ['TypeScript', 'TSX'], ['JavaScript'], ['Python'], ['Java'], ['C#'], ['Markdown'], ['YAML'] (example: value1,value2)", (value) => parseArrayOption(value, 'string'))
